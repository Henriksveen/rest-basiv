package com.basiv.server.auth.endpoints;
...
import com.basiv.server.auth.Common;
import com.basiv.server.auth.DatabaseMock;
...
public class TokenEndpoint {
    ...
    public Response authorize(@Context HttpServletRequest request) throws OAuthSystemException {
        System.out.println("TOKEN STARTET");
        try {
